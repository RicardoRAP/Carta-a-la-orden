...
urlpatterns = [
  ...
  path('reinicio_de_contraseña/', auth_views.PasswordResetView.as_view(template_name='password_reset.html'), name="reset_password"), # Url para el reinicio de la contraseña
  path('reinicio_de_contraseña_envido/', auth_views.PasswordResetDoneView.as_view(template_name='password_reset_sent.html'), name="password_reset_done"), # Url de mensaje de instrucciones a segir para el reiniciar la contraseña
  ...
  path('reinicio_de_contraseña_completado/', auth_views.PasswordResetCompleteView.as_view(template_name='password_reset_complete.html'), name="password_reset_complete"), # Url de mensaje de exito al reiniciar la contraseña 
]